              ...
              <div className="relative">
                {user ? (
                  ...
                  <div className="hidden md:flex items-center space-x-2">
                    <Link to="/login" className="px-4 py-2 text-blue-600 font-medium rounded-lg hover:bg-blue-50 transition-colors">
                      Login
                    </Link>
                    <Link to="/register" className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                      Register
                    </Link>
                  </div>
                )}
              ...
              <div className="flex flex-col space-y-4 px-4">
                ...
                {user ? (
                  <>
                    ...
                    <button onClick={() => { logout(); setIsMenuOpen(false); }} className="font-medium py-2 px-4 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg transition-colors text-left">Logout</button>
                  </>
                ) : (
                  <>
                    <Link to="/login" className="font-medium py-3 text-center text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 transition-all" onClick={() => setIsMenuOpen(false)}>Login</Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">Your one-stop destination for all shopping needs. Quality products, best price, fast delivery, and exceptional customer service.</p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-blue-400 mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                ...
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  <span className="text-gray-400">support@akiramart.com</span>
                </li>
              </ul>
              <h3 className="text-lg font-bold mt-8 mb-4">Newsletter</h3>
              <div className="flex">
                <input type="email" placeholder="Your email" className="flex-grow px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white" />
                <button className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 rounded-r-lg transition-all">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-400">© {new Date().getFullYear()} AkiraMart. All rights reserved.</p>
            <p className="text-gray-500 text-sm mt-2">Crafted with ❤️ for the MERN Stack E-commerce Project</p>
          </div>
        </div>
      </footer>
    </div>
